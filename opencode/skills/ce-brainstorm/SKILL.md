...
*Constraint Check* — Check project instruction files (`AGENTS.md`, `harness.md` and opencode agent config only if retained as compatibility context) for workflow, product, or scope constraints that affect the brainstorm. If these add nothing, move on.
